...
export const mockUser: IUser = {
  ...
  bookmarkedReviews: mockReviews.slice(0, 2),
  reports: [],
  reviews: [
    {
      reviewId: "REVIEW3",
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc rutrum urna et commodo scelerisque. Mauris luctus nulla ut massa cursus ultrices. Donec eleifend ullamcorper nisl a laoreet. Nulla a odio ultrices mauris tincidunt cursus vitae sit amet metus. Praesent eu convallis tortor. Vivamus sit amet fermentum diam, id placerat magna. Ut eu sem sem. Integer vulputate rhoncus massa, ut placerat massa bibendum vel. Integer pharetra tortor enim, lacinia mollis dui dignissim ut. Duis laoreet egestas felis eu varius. Donec sem dui, laoreet elementum purus sit amet, semper rutrum tortor. Maecenas et convallis risus.",
      courseCode: "COMP1511",
      grade: null,
      termTaken: "T2",
      createdTimestamp: '8/12/2022',
    ...
    },
    {
      ...
      zid: "z5555555",
      authorName: "Vivian Wang",
      description: "Aenean fringilla, sapien in lacinia dictum, erat eros commodo erat, quis vestibulum lorem libero ut est. Cras ipsum arcu, iaculis rutrum lacus eu, congue semper mauris. Ut eu mi magna. Phasellus a augue ac lorem pharetra elementum at vestibulum nulla. Cras dapibus pellentesque elit ut mollis. Nam convallis venenatis bibendum. Donec eget velit non lorem dignissim tincidunt. Aenean a odio eu libero volutpat volutpat. Quisque placerat blandit tincidunt. Aliquam in malesuada ante, sit amet sollicitudin diam. Proin varius posuere vestibulum. Nulla dolor lorem, euismod non rhoncus nec, commodo eget justo. Nunc sollicitudin, mauris id pharetra laoreet, erat lectus scelerisque nisl, sed gravida justo justo bibendum nisi. Vivamus consequat eros tincidunt hendrerit ornare. Donec commodo ipsum non fringilla mattis. Sed blandit ex ante, a posuere purus suscipit at.",
      courseCode: "COMP1531",
      grade: null,
      termTaken: "T2",
      createdTimestamp: "8/12/2022",
