...
export default function MostLikedReviewPage() {
  ...
  return (
    <PageTransition>
      <div ref={containerRef} className="absolute w-full h-screen z-[1] overflow-hidden">
        <div ref={glassRef} className="absolute top-[300px] left-[500px] z-[1] cursor-pointer select-none">
          <Image
            width={2880}
            src={MagnifyingGlass}
            alt=""
