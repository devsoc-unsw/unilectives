      ...
      <div className='bg-unilectives-pink w-full h-screen flex flex-col'>
        ...
        <div className='flex-grow grid grid-cols-12 mx-20 mb-8 overflow-hidden'>
          <div className='md:col-span-12 col-span-5 flex flex-col'>
            <h1
              className='text-8xl font-bold italic text-center text-white font-timesnewroman uppercase mb-4'>
              People&apos;s Choice
            </h1>
              ...
              <div className='relative w-full'>
                ...
                <div className='absolute right-[5%] top-[40%] w-1/3 max-w-[200px] min-w-[50px]'>
                  <div className="relative">
                    ...
                    />
                    <p
                      className="absolute xl:text-base lg:text-base md:text-xl text-2xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 !text-black font-extrabold">
                      2024
                    </p>
                  </div>
                </div>
          ...
          <div className='md:col-span-12 col-span-7 ms-10 flex flex-col justify-center'>
            <h1 className='text-6xl md:text-8xl lg:text-[112px] text-white font-neuemetana uppercase'>COMP1511</h1>
            <h3 className='text-2xl md:text-3xl lg:text-4xl font-bold text-white font-neuemetana'>Programming
              Fundamentals</h3>
            <Link className='mt-6 text-white flex items-start gap-3 font-semibold underline'
